...
spec = do
  describe "version check" do
    ...
    it "negative lookahead construction" do
      Check.versionWithoutPath "/nix/store/z9l2xakz7cgw6yfh83nh542pvc0g4rkq-geeqie-2.0.1" (T.pack "2.0.1") `shouldBe` "^(?!.*z9l2xakz7cgw6yfh83nh542pvc0g4rkq-geeqie-).*2\\.0\\.1"
      Check.versionWithoutPath "/nix/store/z9l2xakz7cgw6yfh83nh542pvc0g4rkq-abc" (T.pack "2.0.1") `shouldBe` "^(?!.*z9l2xakz7cgw6yfh83nh542pvc0g4rkq-abc).*2\\.0\\.1"
